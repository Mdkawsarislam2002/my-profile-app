...
export const CartP = [
  ...
  },
  {
    ...
    project: 'Movix.com',
    url: 'https://reliable-semolina-6d3181.netlify.app',
  },
];
...
export const project = [
  {
    id: uuid(),
    projectName: 'Movie App (TMDB API)',
    images: '',
    clientUrl: 'https://reliable-semolina-6d3181.netlify.app/',
    sourceUrl: 'https://github.com/freelanceMamun/movies2.0.git',
    tools: `React Js, React-Redux, CSS or SASS, React-Icons,React-playButoon`,
    details: ``,
    date: '10 May, 2023',
    status: true,
  },
  ...
  {
    id: uuid(),
    projectName: 'Portfolio In Vanila  Javascript',
    images: '',
    clientUrl: 'https://freelancemamun.github.io/my-porfolio/',
    sourceUrl: 'https://github.com/freelanceMamun/my-porfolio.git',
    tools: `Vanila Javascript, (ES6) Feature, HTML, CSS, SASS, Bootsrap 5, Font-awsome-icon`,
    details: ``,
    date: 'Nov 20, 2022',
    status: true,
  },
  {
    id: uuid(),
    projectName: 'Eshop app',
    images: '',
    clientUrl: '',
    sourceUrl: 'https://github.com/freelanceMamun/ESHOP.E.git',
    tools: `React JS, Firebase, Context api, CSS, React-router-dom, React-icons, Swiper,Bootstrap-5, Framer-motion,React-toastify `,
    details: ``,
    date: 'Jan 27, 2023',
    status: false,
  },
  {
    id: uuid(),
    projectName: 'Image Uploader in React',
    images: '',
    clientUrl: 'https://relaxed-dolphin-6883e7.netlify.app/',
    sourceUrl: 'https://github.com/freelanceMamun/image_uploadingin_React.git',
  ...
  {
    id: uuid(),
    projectName: 'Image Editor in Vanila JS',
    images: '',
    clientUrl: 'https://freelancemamun.github.io/Image-Editor/',
    sourceUrl: 'https://github.com/freelanceMamun/Image-Editor.git',
  ...
  },
  {
    ...
    images: '',
    clientUrl: 'https://freelancemamun.github.io/Random_color/',
    sourceUrl: 'https://github.com/freelanceMamun/Random_color.git',
    tools: `Javascript, HTML, CSS`,
    details: ``,
    date: 'June 14, 2022',
    status: true,
  ...
  {
    id: uuid(),
    projectName: 'Vanila JS Shoping Cart',
    images: '',
    clientUrl: 'https://freelancemamun.github.io/cloth-store/',
    sourceUrl: 'https://github.com/freelanceMamun/cloth-store.git',
    tools: `Javascript, HTML, CSS`,
    details: ``,
    date: 'June 14, 2022',
    status: true,
